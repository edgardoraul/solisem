...
class RWMB_Image_Field extends RWMB_File_Field
{
	...
	static function file_info( $file_id, $args = array() )
	{
		...
		$info       = array(
			...
			// Tamaños personalizados Agregados por mi
			// Las thumbnails por defecto
			'large'						=> wp_get_attachment_image_src( $file_id, 'large' )[0],
			'medium'					=> wp_get_attachment_image_src( $file_id, 'medium' )[0],

			// Fotos fijas recortadas
			'custom-thumb-100-100'		=> wp_get_attachment_image_src( $file_id, 'custom-thumb-100-100' )[0],
			'custom-thumb-200-200'		=> wp_get_attachment_image_src( $file_id, 'custom-thumb-200-200' )[0],
			'custom-thumb-300-200'		=> wp_get_attachment_image_src( $file_id, 'custom-thumb-300-200' )[0],
			'custom-thumb-300-300'		=> wp_get_attachment_image_src( $file_id, 'custom-thumb-300-300' )[0],
			'custom-thumb-400-300'		=> wp_get_attachment_image_src( $file_id, 'custom-thumb-400-300' )[0],
			'custom-thumb-600-400'		=> wp_get_attachment_image_src( $file_id, 'custom-thumb-600-400' )[0],
			'custom-thumb-600-600'		=> wp_get_attachment_image_src( $file_id, 'custom-thumb-600-600' )[0],
			'custom-thumb-900-600'		=> wp_get_attachment_image_src( $file_id, 'custom-thumb-900-600' )[0],
			'custom-thumb-900-900'		=> wp_get_attachment_image_src( $file_id, 'custom-thumb-900-900' )[0],

			// Fotos redimensionables según el tamaño de pantalla
			'custom-thumb-200-x'		=> wp_get_attachment_image_src( $file_id, 'custom-thumb-200-x' )[0],
			'custom-thumb-300-x'		=> wp_get_attachment_image_src( $file_id, 'custom-thumb-300-x' )[0],
			'custom-thumb-600-x'		=> wp_get_attachment_image_src( $file_id, 'custom-thumb-600-x' )[0],
			'custom-thumb-900-x'		=> wp_get_attachment_image_src( $file_id, 'custom-thumb-900-x' )[0],
			'custom-thumb-1200-x'		=> wp_get_attachment_image_src( $file_id, 'custom-thumb-1200-x' )[0],
			'custom-thumb-1500-x'		=> wp_get_attachment_image_src( $file_id, 'custom-thumb-1500-x' )[0],
			'custom-thumb-1800-x'		=> wp_get_attachment_image_src( $file_id, 'custom-thumb-1800-x' )[0],
			'custom-thumb-2100-x'		=> wp_get_attachment_image_src( $file_id, 'custom-thumb-2100-x' )[0],
		);
